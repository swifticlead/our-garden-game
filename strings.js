...
const SCENARIOS = [
  // ── Resource Sharing ─────────────────────────────────────────
  { emoji:'🍪', text:'יש לך 4 עוגיות. לאחותך אין.', choices:[
  ...
  { emoji:'🍰', text:'יש חתיכת עוגה גדולה ואחת קטנה. אחותך לא בחרה עדיין.', choices:[
    { label:'💚 את תיקחי את הגדולה!',   generous:true,  flowers:3 },
    { label:'😶 אני רוצה את הגדולה!',   generous:false, flowers:0 }]},

  { emoji:'🍬', text:'קיבלת 3 סוכריות. לאחותך יש רק אחת.', choices:[
    { label:'💚 קחי עוד אחת שלי!',      generous:true,  flowers:3 },
    { label:'💚 בואי נחלק שווה!',        generous:true,  flowers:2 },
    { label:'😶 מגיע לי יותר...',        generous:false, flowers:0 }]},

  { emoji:'🍕', text:'נשארה פרוסת פיצה אחרונה. שתיכן רוצות אותה.', choices:[
  ...
  { emoji:'🎨', text:'שתיכן רוצות את הצבע הורוד.', choices:[
    { label:'💚 בבקשה, קחי קודם!',      generous:true,  flowers:3 },
    { label:'💚 נצבע ביחד!',             generous:true,  flowers:2 },
    { label:'😶 אני קודם!',              generous:false, flowers:0 }]},

  { emoji:'📚', text:'יש ספר אחד מהספרייה שתיכן אוהבות.', choices:[
  ...
  { emoji:'🫧', text:'יש בלון אחרון של סבון.', choices:[
    { label:'💚 את תשתמשי ראשונה!',     generous:true,  flowers:3 },
    { label:'💚 ניקח תורות!',            generous:true,  flowers:2 },
    { label:'😶 שלי!',                   generous:false, flowers:0 }]},

  // ── Turn-Taking ───────────────────────────────────────────────
  { emoji:'🛝', text:'שתיכן רוצות להיות ראשונות במגלשה.', choices:[
  ...
  { emoji:'🎮', text:'יש משחק אחד ושתיכן רוצות לשחק.', choices:[
    { label:'💚 שחקי קודם, אני אחכה!',  generous:true,  flowers:3 },
    { label:'💚 ניקח תורות!',            generous:true,  flowers:2 },
    { label:'😶 אני קודם!',              generous:false, flowers:0 }]},

  { emoji:'🛁', text:'שתיכן רוצות להתרחץ ראשונה.', choices:[
    { label:'💚 תרחצי קודם, זה בסדר!',  generous:true,  flowers:3 },
    { label:'😶 אני קודם!',              generous:false, flowers:0 }]},

  { emoji:'🎠', text:'יש מקום אחד על הנדנדה.', choices:[
    { label:'💚 שבי, אני אמתין!',        generous:true,  flowers:3 },
    { label:'💚 עשרה שניות לי ועשרה לך?', generous:true, flowers:2 },
    { label:'😶 אני עכשיו!',             generous:false, flowers:0 }]},

  // ── Emotional Generosity ──────────────────────────────────────
  { emoji:'👩‍👧', text:'אמא מחבקת את אחותך. את עומדת ורואה.', choices:[
  ...
  { emoji:'🎁', text:'אחותך קיבלה מתנה. את לא קיבלת היום.', choices:[
  ...
  { emoji:'🏆', text:'אחותך ניצחה במשחק ואת הפסדת.', choices:[
  ...
  { emoji:'🖍️', text:'אחותך ציירה ציור יפה מאוד.', choices:[
  ...
  { emoji:'⭐', text:'אמא שיבחה את אחותך על צייתנות.', choices:[
  ...
  { emoji:'🎂', text:'היום יום ההולדת של אחותך.', choices:[
  ...
  // ── Helping ───────────────────────────────────────────────────
  { emoji:'🧸', text:'אחותך עצובה. הבובה האהובה שלך יכולה לעזור לה.', choices:[
  ...
  { emoji:'😢', text:'אחותך בכתה ולא מצליחה לפתור תרגיל.', choices:[
  ...
  { emoji:'🏠', text:'אמא ביקשה לסדר את הסלון. אחותך עייפה.', choices:[
  ...
  { emoji:'🧩', text:'אחותך מנסה להרכיב פאזל ואחד החלקים נפל.', choices:[
    { label:'💚 הנה החלק! אני אעזור לך!',   generous:true,  flowers:3 },
    { label:'😶 תמצאי לבד...',              generous:false, flowers:0 }]},

  // ── Special ───────────────────────────────────────────────────
  { emoji:'💌', text:'אחותך עשתה משהו שגרם לך לכעוס קצת.', choices:[
  ...
  { emoji:'☀️', text:'בוקר חדש! איך נתחיל את היום עם אחותך?', choices:[
  ...
  { emoji:'🌧️', text:'יום גשום בבית. שתיכן משועממות.', choices:[
  ...
  { emoji:'🌙', text:'לפני השינה, אחותך מפחדת מהחושך.', choices:[
  ...
  // ── Food and Treats ────────────────────────────────────────────
  { emoji:'🍦', text:'יש גביע גלידה אחד גדול.', choices:[
  ...
  { emoji:'🍫', text:'קיבלת שוקולד. לאחותך אין.', choices:[
  ...
  { emoji:'🥤', text:'יש כוס מיץ אחת גדולה ושתיכן צמאות.', choices:[
    { label:'💚 שתי קצת, ואני אחריך!',       generous:true,  flowers:2 },
    { label:'💚 בואי נעביר ביניהן!',         generous:true,  flowers:2 },
    { label:'😶 אני קודם, אני יותר צמאה!',  generous:false, flowers:0 }]},

  { emoji:'🍿', text:'יש קערת פופקורן קטנה לסרט.', choices:[
  ...
  { emoji:'🧁', text:'נשאר קאפקייק אחד מהמסיבה.', choices:[
  ...
  // ── Toys and Games ─────────────────────────────────────────────
  { emoji:'🪆', text:'לאחותך אין עם מה לשחק ואת משחקת בבובה שלך.', choices:[
  ...
  { emoji:'🧸', text:'אחותך רוצה לשחק עם הרכבת שלך.', choices:[
  ...
  { emoji:'🪃', text:'יש בומרנג אחד בחוץ ושתיכן רוצות לזרוק.', choices:[
    { label:'💚 זרקי, אני אתפוס!',           generous:true,  flowers:3 },
    { label:'💚 ניקח תורות!',                generous:true,  flowers:2 },
    { label:'😶 אני קודם!',                  generous:false, flowers:0 }]},

  { emoji:'🎨', text:'יש גיר אחד כחול ושתיכן צריכות אותו.', choices:[
    { label:'💚 גמרי קודם, ואני אחריך!',     generous:true,  flowers:3 },
    { label:'💚 בואי נצייר ביחד עם אותו גיר!', generous:true, flowers:2 },
    { label:'😶 אני צריכה אותו עכשיו!',      generous:false, flowers:0 }]},

  { emoji:'🧩', text:'שתיכן רוצות לעשות את הפאזל הגדול.', choices:[
    { label:'💚 בואי נעשה ביחד, יהיה יותר כיף!', generous:true, flowers:2 },
    { label:'💚 את תתחילי, אני אצטרף בעוד רגע!', generous:true, flowers:3 },
    { label:'😶 שלי לעשות לבד!',             generous:false, flowers:0 }]},

  { emoji:'🎭', text:'משחק מחזות — שתיכן רוצות להיות הנסיכה.', choices:[
  ...
  { emoji:'🚲', text:'יש אופניים אחד ושתיכן רוצות לרכוב.', choices:[
    { label:'💚 רכבי עשר דקות, אחר כך אני!', generous:true,  flowers:3 },
    { label:'💚 לכי קודם, בסדר גמור!',       generous:true,  flowers:3 },
    { label:'😶 אני קודם, תמיד אני!',        generous:false, flowers:0 }]},

  { emoji:'⚽', text:'כדור אחד בחצר. שתיכן רוצות לשחק.', choices:[
  ...
  { emoji:'🏊', text:'יש צינורית אחת בבריכה ושתיכן רוצות.', choices:[
    { label:'💚 תרוצי קודם, אני אחכה!',      generous:true,  flowers:3 },
    { label:'💚 ניקח תורות!',                generous:true,  flowers:2 },
    { label:'😶 לקחתי ראשונה!',              generous:false, flowers:0 }]},

  { emoji:'🛴', text:'קורקינט אחד ושתי רוכבות מחכות.', choices:[
    { label:'💚 שתי דקות לך, שתיים לי!',     generous:true,  flowers:2 },
    { label:'💚 תרכבי, אני אשמור על הקסדה!', generous:true,  flowers:3 },
    { label:'😶 שלי!',                       generous:false, flowers:0 }]},

  { emoji:'🪁', text:'יש חבל קפיצה אחד.', choices:[
  ...
  { emoji:'🏖️', text:'יש דלי וגרף אחד בחול.', choices:[
    { label:'💚 תיקחי את הגרף, אני אשתמש בידיים!', generous:true, flowers:3 },
    { label:'💚 בואי נבנה ביחד טירת חול!',   generous:true,  flowers:2 },
    { label:'😶 שלי הכול!',                  generous:false, flowers:0 }]},

  { emoji:'🌳', text:'יש ענף נמוך אחד לטפס עליו.', choices:[
  ...
  // ── Helping and Chores ─────────────────────────────────────────
  { emoji:'🧹', text:'אמא ביקשה לטאטא. אחותך עייפה מאוד.', choices:[
  ...
  { emoji:'🍽️', text:'צריך לסדר את השולחן. אחותך לא מרגישה טוב.', choices:[
  ...
  { emoji:'🌿', text:'צריך להשקות את הצמחים. אחותך שכחה.', choices:[
  ...
  { emoji:'🛏️', text:'אמא ביקשה לסדר את החדר ביחד.', choices:[
    { label:'💚 יאללה, ביחד יהיה מהיר!',     generous:true,  flowers:2 },
    { label:'💚 אני אסדר יותר כי אני גדולה!', generous:true,  flowers:3 },
    { label:'😶 שתסדר היא, אני לא.',         generous:false, flowers:0 }]},

  { emoji:'🐕', text:'הכלב צריך לצאת לטיול. שתיכן עייפות.', choices:[
  ...
  { emoji:'🧺', text:'צריך להכניס כביסה. אחותך מתאמצת עם הסל הכבד.', choices:[
  ...
  // ── Emotional Support ──────────────────────────────────────────
  { emoji:'🤕', text:'אחותך נפלה ונפצעה קצת.', choices:[
  ...
  { emoji:'😔', text:'לאחותך היה יום קשה בגן.', choices:[
  ...
  { emoji:'😡', text:'אחותך כועסת וצועקת עליך.', choices:[
  ...
  { emoji:'🤒', text:'אחותך חולה ושוכבת במיטה.', choices:[
  ...
  { emoji:'😭', text:'אחותך בוכה כי הצעצוע שלה נשבר.', choices:[
  ...
  { emoji:'😰', text:'לאחותך יש מחר מבחן והיא מפחדת.', choices:[
  ...
  // ── Special Occasions ──────────────────────────────────────────
  { emoji:'🎪', text:'הולכים לקרקס! שתיכן רוצות לשבת ליד החלון באוטו.', choices:[
    { label:'💚 שבי, אני אישב בפעם הבאה!',   generous:true,  flowers:3 },
    { label:'💚 נסיעה ראשונה לי, חזרה לך!',  generous:true,  flowers:2 },
    { label:'😶 אני רוצה ליד החלון!',        generous:false, flowers:0 }]},

  { emoji:'🎠', text:'בפארק יש רכבת קטנה — מקום ל-1.', choices:[
    { label:'💚 שבי קודם!',                  generous:true,  flowers:3 },
    { label:'💚 ניקח תורות!',                generous:true,  flowers:2 },
    { label:'😶 אני!',                       generous:false, flowers:0 }]},

  { emoji:'🛍️', text:'אמא קנתה מתנה קטנה רק לאחת מכן.', choices:[
  ...
  { emoji:'📸', text:'צלם צילם תמונה — הייתה מקום לאחת.', choices:[
  ...
  { emoji:'🎟️', text:'נשאר כרטיס אחד לאטרקציה.', choices:[
    { label:'💚 קחי אותו!',                  generous:true,  flowers:3 },
    { label:'💚 בואי נחלק זמן!',             generous:true,  flowers:2 },
    { label:'😶 שלי!',                       generous:false, flowers:0 }]},

  // ── Learning and School ────────────────────────────────────────
  { emoji:'✏️', text:'עיפרון אחד חד ואחד שבור.', choices:[
  ...
  { emoji:'📐', text:'יש סרגל אחד ושתיכן צריכות לצייר קו.', choices:[
  ...
  { emoji:'📖', text:'שיעורי בית — אחותך לא מבינה משהו.', choices:[
    { label:'💚 אני אסביר לה!',              generous:true,  flowers:3 },
    { label:'💚 בואי נחשוב ביחד!',           generous:true,  flowers:2 },
    { label:'😶 שתשאל את המורה!',            generous:false, flowers:0 }]},

  { emoji:'🖊️', text:'יש עט אחד אדום ושתיכן צריכות לסמן.', choices:[
    { label:'💚 קחי, לי יש עט אחר!',         generous:true,  flowers:3 },
    { label:'💚 סמני ותני לי!',              generous:true,  flowers:2 },
    { label:'😶 אני משתמשת!',               generous:false, flowers:0 }]},

  { emoji:'🎒', text:'לאחותך נשפך מיץ על הילקוט שלה.', choices:[
  ...
  { emoji:'📱', text:'אמא נתנה זמן מסך — 20 דקות לטאבלט.', choices:[
  ...
  { emoji:'📺', text:'שתיכן רוצות לראות תוכנית שונה בטלוויזיה.', choices:[
  ...
  { emoji:'🌟', text:'המורה שיבחה את אחותך בפני כולם.', choices:[
  ...
  { emoji:'💝', text:'סבתא הכינה עוגה מיוחדת בשביל אחותך.', choices:[
  ...
  { emoji:'👗', text:'אמא קנתה שמלה חדשה לאחותך.', choices:[
  ...
  { emoji:'🥇', text:'אחותך קיבלה מדליה בתחרות.', choices:[
  ...
  // ── Daily Life ─────────────────────────────────────────────────
  { emoji:'🚿', text:'המים החמים עוד לא חזרו. מי מתרחצת בצוננים?', choices:[
  ...
  { emoji:'💺', text:'כיסא נוח אחד מול השולחן.', choices:[
  ...
  { emoji:'🏺', text:'חומר פיסול אחד — שתיכן רוצות ליצור.', choices:[
  ...
  { emoji:'🎲', text:'במשחק קיבלת הרבה כסף. לאחותך כמעט לא נשאר.', choices:[
  ...
  { emoji:'🃏', text:'בחלוקת קלפים קיבלת קלפים טובים יותר.', choices:[
  ...
  { emoji:'🪑', text:'אחותך עמדה הרבה זמן, יש כיסא אחד.', choices:[
  ...
  { emoji:'📚', text:'ספר אחד לפני שינה — שתיכן רוצות אותו.', choices:[
  ...
  { emoji:'💄', text:'כולם אמרו שאחותך נראית יפה היום.', choices:[
  ...
  { emoji:'🏅', text:'אחותך קיבלה ציון מצוין.', choices:[
  ...
  { emoji:'🌺', text:'מישהו שיבח את ציור אחותך.', choices:[
    { label:'💚 כן, הציור שלה ממש יפה!',       generous:true,  flowers:3 },
    { label:'💚 היא אמנית!',                  generous:true,  flowers:2 },
    { label:'😶 שלי יותר יפה...',             generous:false, flowers:0 }]},

  // ── Problem Solving Together ──────────────────────────────────
  { emoji:'🗺️', text:'הלכתן לאיבוד בפארק.', choices:[
    { label:'💚 אל תפחדי, ניצא ביחד!',        generous:true,  flowers:3 },
    { label:'💚 בואי נחשוב ביחד לאן ללכת!',   generous:true,  flowers:2 },
    { label:'😶 זה בגללך שהלכנו לאיבוד!',     generous:false, flowers:0 }]},

  { emoji:'🔦', text:'הפנס כבה — אחותך מפחדת.', choices:[
    { label:'💚 קחי את ידי!',                 generous:true,  flowers:3 },
    { label:'💚 אל תפחדי, אני כאן!',          generous:true,  flowers:3 },
    { label:'😶 אני גם מפחדת, אין לי כוח!',   generous:false, flowers:0 }]},

  { emoji:'🧪', text:'ניסוי מדע — צריך לערבב יחד.', choices:[
    { label:'💚 את תשפכי ואני אערבב!',        generous:true,  flowers:2 },
    { label:'💚 בואי נחליף תפקידים!',         generous:true,  flowers:2 },
    { label:'😶 אני עושה הכול לבד!',          generous:false, flowers:0 }]},

  // ── Waiting and Patience ──────────────────────────────────────
  { emoji:'⏳', text:'מחכות בתור ארוך. אחותך מתעייפת.', choices:[
  ...
  { emoji:'🚌', text:'מחכות לאוטובוס. יש מקום אחד לשבת.', choices:[
  ...
  { emoji:'🎡', text:'תור ארוך לגלגל הענק. אחותך נדחפה.', choices:[
  ...
  { emoji:'🙏', text:'אחותך שברה בטעות משהו שלך.', choices:[
  ...
  { emoji:'💬', text:'אחותך אמרה משהו שפגע בך, ועכשיו היא מתנצלת.', choices:[
  ...
  { emoji:'🤝', text:'אחרי ריב — מי תפשוט יד ראשונה?', choices:[
